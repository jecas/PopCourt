...
4. Otvori fajl `supabase/schema.sql` iz ovog repozitorijuma, kopiraj ceo sadržaj, nalepi u editor i klikni **Run**.
   ...
   - Ako si `schema.sql` već pokrenula ranije, umesto ponovnog pokretanja celog fajla pokreni samo migracije po redosledu: `supabase/settings-migration.sql`, pa `supabase/credits-migration.sql`, pa `supabase/branding-and-bracket-migration.sql`.
